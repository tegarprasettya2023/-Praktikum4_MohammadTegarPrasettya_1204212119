...
unset($__errorArgs, $__bag); ?> autofocus" type="text" name="firstName" id="firstName" value="" placeholder="Enter First Name">
...
unset($__errorArgs, $__bag); ?> autofocus" type="text" name="lastName" id="lastName" value="" placeholder="Enter Last Name">
...
unset($__errorArgs, $__bag); ?> email" type="text" name="email" id="email" value="" placeholder="Enter Email">
...
unset($__errorArgs, $__bag); ?> autofocus" type="text" name="age" id="age" value="" placeholder="Enter Age">
                            <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH G:\Tugas Semester 4\Pemrograman Framework\ControllerView\resources\views/employee/create.blade.php ENDPATH**/ ?>